...
export const CVETableSkeleton: React.FC = () => (
...
export const CVEDetailsSkeleton: React.FC = () => (
  <div className="space-y-6" aria-busy="true">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      <div className="lg:col-span-2 space-y-6">
        <div className="border border-gray-200 dark:border-gray-800 p-5 rounded-card space-y-4">
          <Shimmer className="h-4 w-1/4" />
...
export const CVEStatsSkeleton: React.FC = () => (
